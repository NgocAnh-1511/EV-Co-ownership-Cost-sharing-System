...
public class ContractAPI {
    ...
    public ResponseEntity<ApiResponse<Map<String, Object>>> deleteContract(@PathVariable Integer contractId) {
        System.out.println("\n" + "=".repeat(80));
        System.out.println("🔵 [ContractAPI] ===== DELETE REQUEST NHẬN ĐƯỢC =====");
        ...
        try {
            System.out.println("🔵 [ContractAPI] Đang gọi contractService.deleteContract(" + contractId + ")");
            contractService.deleteContract(contractId);
            System.out.println("✅ [ContractAPI] contractService.deleteContract() hoàn thành");

            Map<String, Object> response = new HashMap<>();
            response.put("contractId", contractId);
            response.put("deleted", true);

            ApiResponse<Map<String, Object>> apiResponse = ApiResponse.success("Đã xóa hợp đồng thành công", response);
            System.out.println("✅ [ContractAPI] Tạo ApiResponse thành công");
            System.out.println("   ApiResponse.success: " + apiResponse.isSuccess());
            System.out.println("   ApiResponse.message: " + apiResponse.getMessage());
            System.out.println("   ApiResponse.data: " + apiResponse.getData());
            
            ResponseEntity<ApiResponse<Map<String, Object>>> responseEntity = ResponseEntity.ok(apiResponse);
            System.out.println("✅ [ContractAPI] Trả về ResponseEntity với status: " + responseEntity.getStatusCode());
            System.out.println("=".repeat(80) + "\n");
            
            return responseEntity;
        } catch (IllegalArgumentException e) {
            System.err.println("\n" + "=".repeat(80));
            System.err.println("❌ [ContractAPI] ===== HỢP ĐỒNG KHÔNG TỒN TẠI =====");
            ...
            System.err.println("\n" + "=".repeat(80));
            System.err.println("❌ [ContractAPI] ===== EXCEPTION KHI XÓA HỢP ĐỒNG =====");
            System.err.println("   Contract ID: " + contractId);
