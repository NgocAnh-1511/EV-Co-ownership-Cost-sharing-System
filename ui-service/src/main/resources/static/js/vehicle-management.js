...
function editVehicle(id) {
    ...
    // Load vehicle data
    fetch('/admin/vehicle-management/api/' + id)
        .then(response => {
            if (!response.ok) {
...
function saveVehicle(event) {
    ...
    const url = currentVehicleId 
        ? '/admin/vehicle-management/update/' + currentVehicleId
        : '/admin/vehicle-management/add';
...
function confirmDelete() {
    ...
    fetch('/admin/vehicle-management/delete/' + deleteVehicleId, {
        method: 'DELETE'
    })
    .then(response => {
        if (!response.ok) {
