...
public class VehicleServiceService {
    ...
    public Vehicleservice saveVehicleService(Vehicleservice vehicleService) {
        ...
        try {
            ...
            System.out.println("   - Đăng ký dịch vụ mới hoặc cập nhật bản ghi hiện có...");
            ...
            if (existingOpt.isPresent()) {
                ...
                System.out.println("   ℹ️ Bản ghi đã tồn tại → cập nhật thông tin");
            ...
            System.out.println("   - Key: " + savedService.getServiceId() + " / " + savedService.getVehicleId());
