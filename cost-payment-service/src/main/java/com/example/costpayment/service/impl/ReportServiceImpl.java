...
public class ReportServiceImpl implements ReportService {
    ...
    public Map<String, Object> getFinancialReport(Integer groupId, LocalDateTime startDate, LocalDateTime endDate) {
        ...
        try {
            ...
            Map<String, Object> group = restTemplate.getForObject(groupUrl, Map.class);
            ...
            // Lấy quỹ chung
            String fundUrl = "http://localhost:8081/api/funds/group/" + groupId;
            Map<String, Object> fund = restTemplate.getForObject(fundUrl, Map.class);
            
            // Lấy giao dịch quỹ
            String transactionsUrl = fundUrl + "/transactions";
            List<Map<String, Object>> transactions = restTemplate.getForObject(transactionsUrl, List.class);
